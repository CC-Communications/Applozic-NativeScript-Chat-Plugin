...
export class ApplozicChat extends Common {
  ...
  public launchChat() {
    ...
    alChatLauncher.launchChatListAndViewControllerObject(
      "Conversations",
  ...
  public logout(successCallback: any, errorCallback: any) {
    let alRegisterUserClientService = ALRegisterUserClientService.alloc().init();
    alRegisterUserClientService.logoutWithCompletionHandler(function(
      response,
      error
    ) {
  ...
  public defaultSettings() {
    ALApplozicSettings.setStatusBarBGColor(
    ...
    ALApplozicSettings.setTitleForBackButtonMsgVC(
      "Back"
    ...
    ALApplozicSettings.setCustomMessageBackgroundColor(
    ...
    ALApplozicSettings.setDateColor(
      UIColor.colorWithRedGreenBlueAlpha(
        51.0 / 255,
        51.0 / 255,
        51.0 / 255,
    ...
    ALApplozicSettings.setVisibilityForOnlineIndicator(
      true
    ...
    ALApplozicSettings.setMsgTextViewBGColor(
      UIColor.lightGrayColor
    ); /*  SET BG COLOR FOR MESSAGE TEXT VIEW */
    ALApplozicSettings.setPlaceHolderColor(
      UIColor.grayColor
    ); /*  SET COLOR FOR PLACEHOLDER TEXT */
    ALApplozicSettings.setVisibilityNoConversationLabelChatVC(
      true
    ...
    ALApplozicSettings.setColorForToastText(
      UIColor.blackColor
    ); /*  SET COLOR FOR TOAST TEXT    */
    ALApplozicSettings.setColorForToastBackground(
      UIColor.grayColor
    ...
    ALApplozicSettings.setCustomClassName(
      "ALChatManager"
    ); /*  SET 3rd Party Class Name OR ALChatManager */
    ALUserDefaultsHandler.setFetchConversationPageSize(
      60
    ...
    ALUserDefaultsHandler.setDebugLogsRequire(
      true
    ); /*   ENABLE / DISABLE LOGS   */
    ...
    ALUserDefaultsHandler.setGoogleMapAPIKey(
      "AIzaSyBnWMTGs1uTFuf8fqQtsmLk-vsWM7OrIXk"
    ); //REPLACE WITH YOUR GOOGLE MAPKEY
    ...
    ALApplozicSettings.setUserDeletedText(
